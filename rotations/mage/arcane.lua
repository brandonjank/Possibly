-- SPEC ID 62
PossiblyEngine.rotation.register(62, {
  ...
  PossiblyEngine.toggle.create('alter', 'Interface\\ICONS\\spell_mage_altertime', 'Alter Time', 'Toggle the usage of Alter Time and Arcane Power.')
end)
