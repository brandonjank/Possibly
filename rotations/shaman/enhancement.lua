-- SPEC ID 263
PossiblyEngine.rotation.register(263, {
  ...
  PossiblyEngine.toggle.create('totems', 'Interface\\ICONS\\ability_shaman_totemrelocation', 'Totems', 'Toggle the placement of totems.')
end)
