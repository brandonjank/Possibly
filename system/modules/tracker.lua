-- PossiblyEngine Rotations - https://probablyengine.com/
-- Released under modified BSD, see attached LICENSE.

PossiblyEngine.module.register("tracker", {
	units = { }
})
...
explore:SetTable("Aura Tracker", PossiblyEngine.module.tracker.units, 5)
]]

local tracker = PossiblyEngine.module.tracker
